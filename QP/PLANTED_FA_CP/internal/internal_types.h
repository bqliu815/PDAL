...
typedef struct {
  ...
  double *fa_cp_primal_solution;
  double *reflected_primal_solution;
  double *al_sigma_trial_initial_primal_solution;
  double *al_sigma_trial_fa_cp_primal_solution;
  double *dual_product;
  double *initial_dual_solution;
  double *current_dual_solution;
  double *fa_cp_dual_solution;
  double *reflected_dual_solution;
  double *al_sigma_trial_initial_dual_solution;
  double *al_sigma_trial_fa_cp_dual_solution;
  double *primal_product;
  double *al_dual_interaction;
  double step_size;
  double primal_weight;
  double al_sigma;
  int last_sigma_update_iter;
  bool al_sigma_trial_active;
  double al_sigma_trial_previous_sigma;
  double al_sigma_trial_reference_primal;
  double al_sigma_trial_reference_dual;
  double al_sigma_trial_reference_gap;
  int al_sigma_trial_start_iter;
  bool al_sigma_trial_from_gap_dual_stalled;
  bool al_sigma_gap_dual_switch_blocked;
  double al_sigma_trial_snapshot_primal_weight;
  double al_sigma_trial_snapshot_primal_weight_error_sum;
  double al_sigma_trial_snapshot_primal_weight_last_error;
  double al_sigma_trial_snapshot_best_primal_weight;
  double al_sigma_trial_snapshot_best_primal_dual_residual_gap;
  bool use_al_qp;
  int total_count;
