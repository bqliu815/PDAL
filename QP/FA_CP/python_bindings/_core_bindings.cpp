...
static void parse_params_from_python(py::object params_obj, fa_cp_parameters_t *p)
{
...
// module
PYBIND11_MODULE(_fa_cp_core, m)
{
    m.doc() = "fa_cp core bindings (auto-detect dense/CSR/CSC/COO; initialize default params here)";

    m.def("get_default_params", &get_default_params_py,
          "Return default FA_CP parameters as a dict");
