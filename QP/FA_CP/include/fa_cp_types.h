...
typedef enum {
  FA_CP_SIGMA_UPDATE_FIXED = 0,
  FA_CP_SIGMA_UPDATE_RESIDUAL_BALANCE = 1,
  FA_CP_SIGMA_UPDATE_KKT_BALANCE = 2,
  FA_CP_SIGMA_UPDATE_DISPLACEMENT = 3,
  FA_CP_SIGMA_UPDATE_PROGRESS = 4,
  FA_CP_SIGMA_UPDATE_GREEDY_SCORE = 5,
  FA_CP_SIGMA_UPDATE_GUARDED = 6,
  FA_CP_SIGMA_UPDATE_BALANCED_GUARDED = 7
} sigma_update_rule_t;
...
typedef struct {
  ...
  bool use_al_qp;
  double al_sigma;
  sigma_update_rule_t sigma_update_rule;
  double sigma_update_gain;
  double sigma_clip_low;
  double sigma_clip_high;
  double sigma_min;
  double sigma_max;
  double sigma_rollback_tol;
  double sigma_zero_threshold;
  double sigma_activation_threshold;
  double sigma_normal_motion_threshold;
  double sigma_activation_value;
  int verbose;
...
typedef struct {
  ...
  double final_al_sigma;
  int sigma_update_count;
  sigma_update_rule_t sigma_update_rule;
