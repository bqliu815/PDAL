...
typedef struct {
  ...
  double al_sigma;
  double best_al_sigma;
  double best_sigma_score;
  double last_sigma_score;
  double last_sigma_primal_residual;
  double last_sigma_dual_residual;
  double last_sigma_gap;
  int sigma_update_count;
  int sigma_search_direction;
  sigma_update_rule_t sigma_update_rule;
  bool al_qp_available;
  bool use_al_qp;
  int total_count;
  ...
  int restart_current_count;
  int restart_halpern_count;
  int inner_count;
