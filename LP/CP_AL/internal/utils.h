...
#define THREADS_PER_BLOCK 256
    ...
    void compute_interaction_and_movement(cp_al_solver_state_t *solver_state, double *interaction, double *movement);
    ...
    void display_iteration_stats(const cp_al_solver_state_t *solver_state, bool verbose);
