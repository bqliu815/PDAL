...
static void parse_params_from_python(py::object params_obj, cp_al_parameters_t *p)
{
...
static py::dict solve_once(py::object A,
                           ...
                           py::object params = py::none(),       // CP_AL parameters (optional → default)
...
// module
PYBIND11_MODULE(_cp_al_core, m)
{
    m.doc() = "cp_al core bindings (auto-detect dense/CSR/CSC/COO; initialize default params here)";

    m.def("get_default_params", &get_default_params_py, "Return default CP_AL parameters as a dict");
