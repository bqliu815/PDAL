# **Python Interface for CP_AL**

[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](../LICENSE)
[![PyPI version](https://badge.fury.io/py/cp_al.svg)](https://pypi.org/project/cp_al/)
...
This is the Python interface to **[`CP_AL`](../README.md)**, a GPU-accelerated first-order solver for large-scale linear programming (LP).
...
```bash
git clone <your-cp-al-repository-url>
cd CP_AL
pip install .
```
...
By default, `cp_al` solves **minimization problems**.  
...
`cp_al` supports warm starting from user-provided primal and/or dual solutions.
